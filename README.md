...
| `DESCRIPTION_LENGTH_LIMIT` | `5000` | Default max character length for description fields |
| `DESCRIPTION_LENGTH_OVERRIDES` | _(none)_ | JSON object mapping entity types to custom description length limits (e.g. `{"glossaryTerm": 10000, "glossaryNode": 10000}`) |
